    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        if (data.type === "CloudflareChallenge") {
          ...
          let html = await emuRequest(data.url, "GET", this.proxyUrl, headers, 1024 * 1024);
